...
def get_feature_set(data, level_set, feature_type_set, merged=False):
...
def get_merged_feature_set(data, level_set, feature_type_set):
    return get_feature_set(data=data, level_set=level_set, feature_type_set=feature_type_set, merged=True)
